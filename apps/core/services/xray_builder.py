...
def _build_balancers(outbounds) -> list:
    ...
    strategy leastPing включает автоматический failover: Xray сам
    выбирает наименее задержанный живой outbound из группы и переключается
    на следующий при недоступности текущего.
    """
    ...
    return [
        {"tag": balancer_tag, "selector": tags, "strategy": {"type": "leastPing"}}
